    ...
    <md-card-content>
      <div class="md-layout md-gutter">
        <div class="md-layout-item md-large-size-50 md-medium-size-50 md-small-size-50 md-xsmall-size-50">
          ...
          <p :style="rate_for_day - 1>0?'color: red;font-size: 25px;text-align: center':'color: green;font-size: 25px;text-align: center'">{{((rate_for_day - 1)).toFixed(2)}}%</p>
        </div>
        <div class="md-layout-item md-large-size-50 md-medium-size-50 md-small-size-50 md-xsmall-size-50">
      ...
      <div v-show="jingzhi||zhangdiefu">
        ...
        <p style="color: #555;font-size: 25px;text-align: right" v-if="zhangdiefu" v-show="zhangdiefu">
          {{day < zhangdiefuData.length?'':'由于该基金数据过短，故仅显示到'+zhangdiefuData.length+'个交易日'}}
        </p>
