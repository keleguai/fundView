  ...
  <div>
    ...
    <div class="md-layout md-gutter md-alignment-top-center">
      ...
      <div
        ...
        <md-card :class="!$store.state.isAndroid?'md-elevation-2':''" md-with-hover style="padding: 0">
  ...
  export default {
    ...
    methods: {
      ...
      getNormalFunds() {
        let _this = this;
        // _this.$loading.show()
        this.$myapi.get('/fund/list/1/20', null, function (res) {
      ...
      getNormalStocks() {
        let _this = this;
        // _this.$loading.show()
        this.$myapi.get('/stock/list/1/50', null, function (res) {
      ...
      getNormalManagers() {
        let _this = this;
        // _this.$loading.show()
        this.$myapi.get('/fund_manager/list/1/50', null, function (res) {
